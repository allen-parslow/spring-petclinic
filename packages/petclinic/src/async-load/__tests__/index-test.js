...
const shallowComponent = (props) => shallow(<LoadAsync {...props}><div className="children">Some Children</div></LoadAsync>);
...
describe("LoadAsync Component", () => {  
  ...
  it("Should render results when no load callback provided", () => {
    props.load = null;
    const wrapper = shallowComponent(props);
